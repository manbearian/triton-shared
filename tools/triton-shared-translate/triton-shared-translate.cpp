...
LogicalResult tritonSharedTranslateMain(int argc, char **argv,
...
int main(int argc, char **argv) {
  return failed(mlir::triton::tritonSharedTranslateMain(
      argc, argv, "Triton-Shared Translate Testing Tool."));
}
